...
def generate_urls(query, pages):
    url_template = (
        f"{BASE_URL}/?q={query}"
        "&type=o&order_by=score+desc&case_name=Siemens&stat_Published=on&page={page_num}"
    )
    var = "&type=o&order_by=dateFiled+desc&stat_Published=on&page={page_num}"
    var2 = "?q=%22Patents%22&type=o&order_by=score+desc&case_name=Siemens&stat_Published=on&page={page_num}"
